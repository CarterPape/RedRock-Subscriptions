...
function memberful_wp_shortcode_buy_download_link($atts, $content) {
    ...
    return "<a class='{$atts['class']}' href='".$url."'>".do_shortcode($content)."</a>";
}
...
function memberful_wp_shortcode_register_link($atts, $content) {
    return "<a class='{$atts['class']}' href='".memberful_registration_page_url()."' role='register'>".do_shortcode($content)."</a>";
}

function memberful_wp_shortcode_sign_out_link($atts, $content) {
    return "<a class='{$atts['class']}' href='".memberful_sign_out_url()."' role='sign_out'>".do_shortcode($content)."</a>";
}

function memberful_wp_shortcode_sign_in_link($atts, $content) {
    return "<a class='{$atts['class']}' href='".memberful_sign_in_url()."' role='sign_in'>".do_shortcode($content)."</a>";
}

function memberful_wp_shortcode_account_link($atts, $content) {
    return "<a class='{$atts['class']}' href='".memberful_account_url()."' role='account'>".do_shortcode($content)."</a>";
}
