...
An object that is a Service:
    ...
    2. Emplaces callbacks of objects that may not necessarily be the Service implementation itself, e.g. action responders, filters, synchronizers, and view controllers. This action of emplacing callbacks provides appropriate objects (perhaps the Service implementation, itself) an opportunity to respond to other steps of WordPress setup.
