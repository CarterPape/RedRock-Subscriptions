...
function memberful_wp_metabox_acl_format(
    $acl_list,
    $entity
)
{
...
class Memberful_Post_ACL {
    ...
    protected function _update_post_acl(
        $post_id,
        array $new_acl
    )
    {
     ...
     *
     */
    protected function _remove_deleted_entities(
        $post_id,
        array $map,
        array $old_acl,
        array $new_acl
     ...
     */
    protected function _add_new_entities(
        $post_id,
        array $map,
        array $old_acl,
        array $new_acl
