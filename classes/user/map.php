...
class Memberful_User_Map {
    ...
    private function run_mapping_preconditions(
        $mapping_from_member,
    ...
    private function ensure_mapping_is_correct(
        $mapping_from_member_exists,
        $mapping_from_user_exists,
        $wp_user,
        $member,
    ...
    private function add_data_to_wp_error(
        WP_Error $error,
        array $data
    )
    {
...
class Memberful_User_Mapping_Repository {
    ...
    public function update_mapping_by_member(
        $wp_user,
        $member,
        array $context
    )
    ...
    public function update_mapping_by_user(
        $wp_user,
        $member,
        array $context
    )
