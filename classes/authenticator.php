...
class Memberful_Authenticator {
     ...
     * @return boolean
     */
    static public function audit_password_reset(
        $allowed,
        $user_id
    )
    {
    ...
    public function ask_user_to_verify_they_want_to_sync_accounts(
        $existing_wp_user,
        $memberful_member,
        array $sync_context
    )
...
function memberful_wp_link_accounts_if_appropriate(
    $username,
    $user
)
{
